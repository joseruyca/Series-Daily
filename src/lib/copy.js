export const copy = {
  es: {
    ...
    challenge: {
      dateLabel: "Hoy",
      chooseLabel: "Elige una respuesta",
      yourAnswer: "Tu respuesta",
      correctAnswer: "Respuesta correcta",
      correct: "Correcto",
      incorrect: "No era esa",
      completed: "Ya jugado hoy",
      tomorrow: "Vuelve mañana para el siguiente reto.",
    ...
    classic: {
      ...
      attempts: "Intentos",
      hint: "Pista",
      notFound: "Ese personaje no está en la lista.",
      repeated: "Ese personaje ya lo has probado.",
      solved: "Lo has adivinado.",
      failed: "Se acabaron los intentos.",
      answer: "Personaje correcto",
